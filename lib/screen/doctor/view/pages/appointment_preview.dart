...
class PreviewAppointmentView extends GetView<DoctorController> {
  const PreviewAppointmentView({Key? key}) : super(key: key);
              ...
              Card(
                child: Container(
                  child: Column(
                    children: [
                      Text(
                        "Doctor Name: ${controller.doctorName.value}",
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Text(
                        "Hospital Name: ${controller.scheduleList.value[index].hospital}",
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Divider(),
                      ListTile(
                        title: Text("Discount"),
                        trailing: Text(
                          "${controller.scheduleList.value[index].discount} TK",
